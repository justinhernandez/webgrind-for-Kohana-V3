 ...
 */
class Webgrind_Filehandler_Core
{
	...
	private function getFiles($format, $dir){
		...
		foreach($list as $file){
			...
			if (false !== strstr($absoluteFilename, $this->suffix))
			    continue;
			...
			if (Kohana::config('webgrind.hideWebgrindProfiles') && $invokeUrl == dirname(dirname(__FILE__)).DIRECTORY_SEPARATOR.'index.php')
			    continue;
